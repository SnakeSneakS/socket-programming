...
help: ## show help ## make help ## 
	...
	@echo ""
	@echo "Usage: "
	@echo "1. build and run web server:    make build-server-module && make build-server && run-web-server"
	@echo "2. build and run proxy server:  make build-server-module && make build-server && run-proxy-server"
	@echo ""
	@echo "Command list:"
